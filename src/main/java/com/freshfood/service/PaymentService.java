...
public class PaymentService {
    ...
    public ResponseData<?> createVnPayPayment(HttpServletRequest request, OrderRequestDTO orderRequestDTO) throws UnsupportedEncodingException, JsonProcessingException {
        long amountt = (long) (orderRequestDTO.getTotalPrice() * 100);
